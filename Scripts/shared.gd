...
var cells = {
	Tetromino.I: Matrix2D.new(4, 1, 0, [
		[Tetromino.I, Tetromino.I, Tetromino.I, Tetromino.I],
	]),
	Tetromino.J: Matrix2D.new(3, 2, 0, [
		[Tetromino.J, 0, 0],
		[Tetromino.J, Tetromino.J, Tetromino.J],
	]),
	Tetromino.L: Matrix2D.new(3, 2, 0, [
		[0, 0, Tetromino.L],
	...
	Tetromino.S: Matrix2D.new(3, 2, 0, [
		[0, Tetromino.S, Tetromino.S],
		[Tetromino.S, Tetromino.S, 0],
	]),
	Tetromino.T: Matrix2D.new(3, 2, 0, [
		[0, Tetromino.T, 0],
		[Tetromino.T, Tetromino.T, Tetromino.T],
	]),
	Tetromino.Z: Matrix2D.new(3, 2, 0, [
